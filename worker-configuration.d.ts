/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 475202846ce0271a93f2a37c89c7362f)
...
interface __BaseEnv_Env {
	...
	AI_PROVIDERS: string;
	AI_PROVIDER_KEY_MAIN: string;
	WAFFO_MERCHANT_ID: string;
	WAFFO_PRIVATE_KEY: string;
	CONTENT_SCAN_ENABLED: string;
	QUIZ_DO: DurableObjectNamespace<import("./src/index").QuizGenerationDO>;
	OCR_DO: DurableObjectNamespace<import("./src/index").OCRProcessingDO>;
	API_WORKER: Fetcher /* we-learning-suite-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QuizGenerationDO" | "OCRProcessingDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "AI_GENERATE_MODEL" | "AI_OCR_MODEL" | "AI_PLAN_MODEL" | "AI_GATEWAY_ID" | "WAFFO_SCAN_BASE_URL" | "SCAN_MAX_CHARS" | "SCAN_CONCURRENCY" | "SCAN_TIMEOUT_MS" | "AI_PROVIDERS" | "AI_PROVIDER_KEY_MAIN" | "WAFFO_MERCHANT_ID" | "WAFFO_PRIVATE_KEY" | "CONTENT_SCAN_ENABLED">> {}
}
